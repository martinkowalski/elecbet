classdef InOpenRange < BetType
    %INOPENRANGE Bet type InOpenRange
    ...
    methods
        function betType = InOpenRange(lowlim,party,uprlim)
            %INOPENRANGE Ctor
            %   Erstellt betType InOpenRange und passende Description
        ...
        function b = iswon(betType,R)
            %ISWON True if InOpenRange bet is won.
